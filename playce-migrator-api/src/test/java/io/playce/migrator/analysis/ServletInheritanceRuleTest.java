...
@SpringBootTest
@Slf4j
public class ServletInheritanceRuleTest {
    @Autowired
    ...
    void testFileRuleLoader() {
        ...
        request.setContent("public class TestServlet extends HttpServlet {");
//        request.setContent("public class TestServlet extends javax.servlet.http.HttpServlet {");
//        request.setContent("import org.springframework.web.servlet.support.AbstractAnnotationConfigDispatcherServletInitializer;");
